    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SelfPacedAttempts", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SelfPacedAttempts_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_SelfPacedAttempts_Quizzes_QuizId",
                        column: x => x.QuizId,
                        principalTable: "Quizzes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_SessionParticipants_QuizSessions_SessionId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SelfPacedAnswers", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SelfPacedAnswers_Answers_SelectedAnswerId",
                        column: x => x.SelectedAnswerId,
                        principalTable: "Answers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_SelfPacedAnswers_Questions_QuestionId",
                        column: x => x.QuestionId,
                        principalTable: "Questions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_SelfPacedAnswers_SelfPacedAttempts_AttemptId",
                        column: x => x.AttemptId,
                        principalTable: "SelfPacedAttempts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SessionResponses_Answers_SelectedAnswerId",
                        column: x => x.SelectedAnswerId,
                        principalTable: "Answers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_SessionResponses_Questions_QuestionId",
                        column: x => x.QuestionId,
                        principalTable: "Questions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_SessionResponses_SessionParticipants_SessionParticipantId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SelfPacedAnswers_AttemptId",
                table: "SelfPacedAnswers",
                column: "AttemptId");

            migrationBuilder.CreateIndex(
                name: "IX_SelfPacedAnswers_QuestionId",
                table: "SelfPacedAnswers",
                column: "QuestionId");

            migrationBuilder.CreateIndex(
                name: "IX_SelfPacedAnswers_SelectedAnswerId",
                table: "SelfPacedAnswers",
                column: "SelectedAnswerId");

            migrationBuilder.CreateIndex(
                name: "IX_SelfPacedAttempts_QuizId",
                table: "SelfPacedAttempts",
                column: "QuizId");

            migrationBuilder.CreateIndex(
                name: "IX_SelfPacedAttempts_UserId",
                table: "SelfPacedAttempts",
                column: "UserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SessionResponses_QuestionId",
                table: "SessionResponses",
                column: "QuestionId");

            migrationBuilder.CreateIndex(
                name: "IX_SessionResponses_SelectedAnswerId",
                table: "SessionResponses",
                column: "SelectedAnswerId");

            migrationBuilder.CreateIndex(
                name: "IX_SessionResponses_SessionParticipantId",
                table: "SessionResponses",
